    ...
    <div className="space-y-6">
      ...
      <section>
        ...
        <p className="mt-2 max-w-4xl text-sm leading-6 text-[var(--muted-foreground)]">
          Registre sua marcação de ponto. O sistema classificará automaticamente
          o tipo conforme a sequência cronológica do dia.
        </p>
      </section>
            ...
            <div className="mt-4 rounded-lg border bg-[var(--muted)] p-4 text-sm">
              ...
              {exigeReconhecimentoFacial && (
                <p className="mt-1 text-xs text-[var(--muted-foreground)]">
                  Regra preparada: a primeira marcação do dia exigirá
                  reconhecimento facial quando o módulo biométrico for ativado.
                </p>
              )}
            </div>
          )}
