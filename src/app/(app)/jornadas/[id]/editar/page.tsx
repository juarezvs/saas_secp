  ...
  return (
    <div className="space-y-6">
      ...
      <RegraPortariaCard
        ...
        titulo="Horário diferenciado"
        descricao="A Portaria prevê que, havendo viabilidade técnica, o sistema cadastre horários individuais e horários diferenciados."
      />
