...
export async function DashboardSecap() {
  ...
  return (
    <DashboardPerfilShell
      ...
      description="Acompanhe boletins encaminhados, recebidos e conferidos para providências administrativas de pessoal."
      icon={FileCheck2}
    >
      <section className="grid gap-4 md:grid-cols-3">
        <DashboardRoleCard
          titulo="Encaminhados"
          valor={encaminhados}
          descricao="Boletins enviados para conferência SECAP/NUCGP."
          icon={Send}
        />
        <DashboardRoleCard
          titulo="Recebidos"
          valor={recebidos}
          descricao="Boletins recebidos e aguardando conferência final."
          icon={FileCheck2}
        />
        <DashboardRoleCard
          titulo="Conferidos"
          valor={conferidos}
          descricao="Boletins já conferidos administrativamente."
          icon={ShieldCheck}
        />
      </section>
